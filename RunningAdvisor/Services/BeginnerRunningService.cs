...
namespace RunningAdvisor.Services
{
    public class BeginnerRunningService
    {
        ...
        public async Task<List<BeginnerRunningData>> GetAllRecordsAsync()
        {
        ...
        public async Task<string> GenerateIndividualPlanAsync(int id)
        {
            ...
            bool isBeginner = record.Time3k < TimeSpan.FromMinutes(15) && record.Time5k < TimeSpan.FromMinutes(30) && record.Time10k < TimeSpan.FromHours(1);
