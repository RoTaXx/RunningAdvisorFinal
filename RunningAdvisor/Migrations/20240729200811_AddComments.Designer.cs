...
namespace RunningAdvisor.Migrations
{
    ...
    [Migration("20240729200811_AddComments")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RunningAdvisor.Models.Entities.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("RunningAdvisor.Models.Entities.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("RunningAdvisor.Models.Entities.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("RunningAdvisor.Models.Entities.Comment", b =>
                {
                    b.HasOne("RunningAdvisor.Models.Entities.ApplicationUser", "User")
                        .WithMany("Comments")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
